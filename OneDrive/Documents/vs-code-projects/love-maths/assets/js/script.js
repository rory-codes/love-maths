...
function checkAnswer() {
    ...
    if (isCorrect) {
        ...
        alert(`awwwww... you answered ${userAnswer}. The correct answer was ${calculatedAnswer}!`);
...
/**
 * Gets the current tally of incorrect answers from the DOM and incremenets iy by 1
 */
